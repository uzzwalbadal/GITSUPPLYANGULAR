...
export class CustomersComponent implements OnInit {
  ...
  OnSubmit() {
    ...
    DataSaveModel.id = this.customersForm.controls['id'].value;
    DataSaveModel.name = this.customersForm.controls['name'].value;
    DataSaveModel.type = this.customersForm.controls['description'].value;
    DataSaveModel.location = this.customersForm.controls['description'].value;
    DataSaveModel.contact = this.customersForm.controls['description'].value;
  ...
  update(): void {
    ...
    DataSaveModel.location = this.customersForm.controls['description'].value;
    DataSaveModel.contact = this.customersForm.controls['description'].value;
    DataSaveModel.customerTypeId = this.customersForm.controls['productTypeId'].value;
    // console.log(this.products);
