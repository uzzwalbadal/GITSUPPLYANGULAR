...
import { DocumentsComponent } from './Complaints/documents.component';
import { CustomersService } from './customers/customer.service';
import { SuppliersService } from './suppliers/suppliers.service';
import { ComplaintsService } from './Complaints/complaint.service';
import { TransactionsService } from './transaction/transaction.service';
import { OrderTrackingService } from './ordertracking/ordertracking.service';
...
@NgModule({
  ...
  providers: [ProductsService,CustomersService,SuppliersService,ComplaintsService,TransactionsService, OrderTrackingService ],
  entryComponents: [
    // tenants
    CreateTenantDialogComponent,
    EditTenantDialogComponent,
