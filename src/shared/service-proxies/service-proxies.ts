...
export class ProductServiceProxy {
     ...
     * @return Success
     */
    get(id: number | null | undefined): Observable<Dto_Product> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<Dto_Product>><any>_observableThrow(e);
                }
            } else
                return <Observable<Dto_Product>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<Dto_Product> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Dto_Product.fromJS(resultData200) : new Dto_Product();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<Dto_Product>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfDto_Product> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfDto_Product>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfDto_Product>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfDto_Product> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfDto_Product.fromJS(resultData200) : new PagedResultDtoOfDto_Product();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfDto_Product>(<any>null);
    }
     ...
     * @return Success
     */
    create(input: Dto_Product | null | undefined): Observable<Dto_Product> {
    ...
    protected processCreate(response: HttpResponseBase): Observable<Dto_Product> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(input: Dto_Product | null | undefined): Observable<Dto_Product> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<Dto_Product> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ProductTypeServiceProxy {
     ...
     * @return Success
     */
    get(id: number | null | undefined): Observable<Dto_ProductTypes> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<Dto_ProductTypes>><any>_observableThrow(e);
                }
            } else
                return <Observable<Dto_ProductTypes>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<Dto_ProductTypes> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Dto_ProductTypes.fromJS(resultData200) : new Dto_ProductTypes();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<Dto_ProductTypes>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfDto_ProductTypes> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfDto_ProductTypes>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfDto_ProductTypes>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfDto_ProductTypes> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfDto_ProductTypes.fromJS(resultData200) : new PagedResultDtoOfDto_ProductTypes();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfDto_ProductTypes>(<any>null);
    }
     ...
     * @return Success
     */
    create(input: Dto_ProductTypes | null | undefined): Observable<Dto_ProductTypes> {
    ...
    protected processCreate(response: HttpResponseBase): Observable<Dto_ProductTypes> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(input: Dto_ProductTypes | null | undefined): Observable<Dto_ProductTypes> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<Dto_ProductTypes> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class Dto_Product implements IDto_Product {
    name: string | undefined;
    description: string | undefined;
    productTypeId: number | undefined;
    id: number | undefined;

    constructor(data?: IDto_Product) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Dto_Product {
        data = typeof data === 'object' ? data : {};
        let result = new Dto_Product();
        result.init(data);
        return result;
    }
...
export class PagedResultDtoOfDto_Product implements IPagedResultDtoOfDto_Product {
    totalCount: number | undefined;
    items: Dto_Product[] | undefined;

    constructor(data?: IPagedResultDtoOfDto_Product) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                ...
                for (let item of data["items"])
                    this.items.push(Dto_Product.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfDto_Product {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfDto_Product();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedResultDtoOfDto_Product {
        const json = this.toJSON();
        let result = new PagedResultDtoOfDto_Product();
        result.init(json);
        return result;
...
export interface IPagedResultDtoOfDto_Product {
    totalCount: number | undefined;
    items: Dto_Product[] | undefined;
}

export class Dto_ProductTypes implements IDto_ProductTypes {
    name: string | undefined;
    id: number | undefined;

    constructor(data?: IDto_ProductTypes) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Dto_ProductTypes {
        data = typeof data === 'object' ? data : {};
        let result = new Dto_ProductTypes();
        result.init(data);
        return result;
    }
...
export interface IDto_ProductTypes {
    name: string | undefined;
    id: number | undefined;
}

export class PagedResultDtoOfDto_ProductTypes implements IPagedResultDtoOfDto_ProductTypes {
    totalCount: number | undefined;
    items: Dto_ProductTypes[] | undefined;

    constructor(data?: IPagedResultDtoOfDto_ProductTypes) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(Dto_ProductTypes.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfDto_ProductTypes {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfDto_ProductTypes();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedResultDtoOfDto_ProductTypes {
        const json = this.toJSON();
        let result = new PagedResultDtoOfDto_ProductTypes();
        result.init(json);
        return result;
...
export interface IPagedResultDtoOfDto_ProductTypes {
    totalCount: number | undefined;
    items: Dto_ProductTypes[] | undefined;
}
